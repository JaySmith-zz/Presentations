<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationView.aspx.cs" Inherits="Attendee.Web_CS.RegistrationView" %>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="3" style="text-align: left;">
                        <strong>
                        Attendee Information</strong></td>
                </tr>
                <tr>
                    <td style="text-align: left; width: 259px;">
                        <asp:Label ID="Label1" runat="server" Text="First Name:" Width="104px"></asp:Label></td>
                ...
                <tr>
                    <td style="text-align: left; width: 259px;">
                        <asp:Label ID="Label2" runat="server" Text="Last Name:" Width="104px"></asp:Label></td>
                    <td style="text-align: left; width: 295px;">
                ...
                <tr>
                    <td style="text-align: left; width: 259px; height: 22px;">
                        <asp:Label ID="Label3" runat="server" Text="Age:" Width="104px"></asp:Label></td>
                ...
                <tr>
                    <td style="text-align: right;" colspan="2">
                        <asp:Button ID="ButtonRegister" runat="server" Text="Register"
                            ValidationGroup="FormValidation" onclick="ButtonRegister_Click" /></td>
